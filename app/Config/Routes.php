...
$routes->post('/actus-save', 'ActuController::actuRegistration');
$routes->get('/updatePage', 'ActuController::updatePage');
$routes->post('/update', 'ActuController::update');
$routes->get('/delete', 'ActuController::delete');
