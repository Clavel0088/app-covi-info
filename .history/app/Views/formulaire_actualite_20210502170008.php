		    			...
		    			<div class="col-md-12">
		    				<form class="form" action="<?php echo base_url('loginPage'); ?>" method="POST">
		    					...
		    					<div class="form-group">
		    						...
		    						<textarea class="form-control" type="" name="description" required>

                                    <label class="navLink" for="description" style="color: #f9b507;">Pays</label>
		    						<textarea class="form-control" type="text" name="description" required>

                                    <label class="navLink" for="description" style="color: #f9b507;">Image</label>
		    						<input class="form-control" type="file" name="description" required>
